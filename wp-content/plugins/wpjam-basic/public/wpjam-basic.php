...
class WPJAM_Basic{
	...
	public static function get_setting($name, $default=null){
		$value	= wpjam_basic_get_setting($name, $default);
...
function wpjam_basic_get_setting($name, $default=null){
	return wpjam_option_get_setting('wpjam-basic', $name, $default);
}

function wpjam_basic_update_setting($name, $value){
	return wpjam_option_update_setting('wpjam-basic', $name, $value);
}

function wpjam_basic_delete_setting($name){
	return wpjam_option_delete_setting('wpjam-basic', $name);
}
