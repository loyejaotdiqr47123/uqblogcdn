...
class WPJAM_Toc{
	...
	public static function get_setting($name, $default=null){
		return wpjam_option_get_setting('wpjam-toc', $name, $default);
	}
	...
	public static function init(){
		add_filter('the_content',	['WPJAM_Toc', 'filter_content'], 11);
		...
		if(is_admin()){
			if(!is_network_admin() && !is_user_admin()){
				wpjam_register_plugin_page_load('wpjam-toc', [
					'plugin_page'	=> 'wpjam-posts', 
					'current_tab'	=> '',
					'callback'		=> [self::class, 'plugin_page_load']
				]);
